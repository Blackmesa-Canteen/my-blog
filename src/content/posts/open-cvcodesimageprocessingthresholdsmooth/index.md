---
title: 'Open-cv Codes: Image Processing & Threshold & Smooth'
slug: open-cvcodesimageprocessingthresholdsmooth
date: '2021-07-05T05:50:25Z'
categories:
- Notes
tags:
- OpenCV
cover: ./download (1)-16341997c087421b919f01200c200ae0.png
original_permalink: /archives/open-cvcodesimageprocessingthresholdsmooth
---



Codes below are used in my cv projects during the internship. These practices are useful in pretreatments of inputs.
```python
import cv2
