---
title: '[转载] React.js基础知识速查'
slug: -zhuan-zai-reactjs-ji-chu-zhi-shi-su-cha
date: '2022-05-26T02:42:52.699Z'
categories:
- Notes
- Improvement
- Utilities
...
- Notes
- React.js
original_permalink: /archives/-zhuan-zai-reactjs-ji-chu-zhi-shi-su-cha
---

# Copyright
[React入门到实战(2022全网最新)](https://www.bilibili.com/video/BV1Z44y1K7Fj?p=44)
...
1. 声明式UI（JSX）
   ...
   ![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/compare.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/create-react.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/jsx02.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/jsx03.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/jsx-demo.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/components.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/state-update.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/this.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/props-1.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/props-2.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/props-4.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/props-5.png?raw=true -->
...
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/context.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/props-3.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/props-rule.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/life.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/life1.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/life2.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/state01.png?raw=true -->
...
![](./placeholder.png)
<!-- original image (unavailable): D:/react课程全系列/课程讲义及资源/课程讲义/1.React基础课/https://github.com/Blackmesa-Canteen/react-learn-note/blob/main/1.基础文档/assets/context.png?raw=true -->
